    ...
    render() {
        return (
            <ContentPage {...this._contentProps} >
                <Helmet>
                  <title>Modernizing Control | Verboze</title>
                  <meta name="description" content="Introducing the hospitality industry to the 21st century." />
                  <meta name="path" content="/modernizing-control" />
                </Helmet>
